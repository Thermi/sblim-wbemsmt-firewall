...
# Description:
#
# This file is a JPackage based startup script for the SBLIM WBEM-SMT Firewall
...
CLASSPATH=$(build-classpath sblim-wbemsmt/sblim-wbemsmt-firewall):$CLASSPATH
CLASSPATH=$(build-classpath sblim-wbemsmt/sblim-wbemsmt-commons):$CLASSPATH

#######################################
# Set additional parameter
#
OPTIONS=-Djava.util.logging.config.file=/etc/java/sblim-wbemsmt/logging-cmd.properties -Dcommands=org.sblim.wbemsmt.firewall.cli.Commands
