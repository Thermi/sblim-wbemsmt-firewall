@REM ##############################################################################
@REM sblim-wbemsmt-firewall-cli.bat
@REM
...
@REM Description:
@REM
@REM This file is a startup script for the SBLIM WBEM-SMT Firewall
...
SET CLASSPATH=%CLASSPATH%;lib\sblim-wbemsmt-firewall-0.2.1.jar
...
SET VM_OPTIONS=-Djava.util.logging.config.file=cmdlogging.properties -Dcommands=org.sblim.wbemsmt.firewall.cli.Commands
