/** 
  * Linux_FirewallInterfaceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallInterface
  *    
  * 
  * generated Class
  * @see Linux_FirewallInterface
  */
...
public class Linux_FirewallInterfaceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallInterface or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallInterface.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallInterface.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallInterface or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallInterface> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallInterface> resultArrayList = new ArrayList<Linux_FirewallInterface>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallInterface.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallInterface(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallInterfaceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallInterface.");
                        resultArrayList.add(new Linux_FirewallInterface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallInterface.");
                        resultArrayList.add(new Linux_FirewallInterface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallInterface)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallInterface.");
                        resultArrayList.add(new Linux_FirewallInterface(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallInterface getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallInterface getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallInterface dataInstance = null;
        Class<?> clazz = Linux_FirewallInterfaceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallInterface)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallInterface.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallInterface(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallInterface getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_FirewallInterface.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallInterface.CIM_CLASS_NAME); 
                   
                   setThis = DeviceID;
                
           keyProperties[1]  = new CIMProperty(Linux_FirewallInterface.PROPERTY_DEVICEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallInterface.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(Linux_FirewallInterface.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallInterface.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(Linux_FirewallInterface.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallInterface.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallInterface.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallInterface createInstance(WBEMClient client, Linux_FirewallInterface dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallInterface newDataInstance = Linux_FirewallInterfaceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallInterface modifyInstance(WBEMClient client, Linux_FirewallInterface dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallInterface dataInstance2 = Linux_FirewallInterfaceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallInterface dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallInterface.getPackages());
    }
