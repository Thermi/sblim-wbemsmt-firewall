/** 
  * Linux_FirewallManagedPortsForInterfaceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallManagedPortsForInterface
  *    
  * 
  * generated Class
  * @see Linux_FirewallManagedPortsForInterface
  */
...
public class Linux_FirewallManagedPortsForInterfaceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallManagedPortsForInterface or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallManagedPortsForInterface.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallManagedPortsForInterface.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallManagedPortsForInterface or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallManagedPortsForInterface> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallManagedPortsForInterface> resultArrayList = new ArrayList<Linux_FirewallManagedPortsForInterface>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallManagedPortsForInterface.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallManagedPortsForInterface(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallManagedPortsForInterfaceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallManagedPortsForInterface.");
                        resultArrayList.add(new Linux_FirewallManagedPortsForInterface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallManagedPortsForInterface.");
                        resultArrayList.add(new Linux_FirewallManagedPortsForInterface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallManagedPortsForInterface)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallManagedPortsForInterface.");
                        resultArrayList.add(new Linux_FirewallManagedPortsForInterface(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallManagedPortsForInterface getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallManagedPortsForInterface getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallManagedPortsForInterface dataInstance = null;
        Class<?> clazz = Linux_FirewallManagedPortsForInterfaceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallManagedPortsForInterface)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallManagedPortsForInterface.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallManagedPortsForInterface(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallManagedPortsForInterface getInstance(WBEMClient client, String namespace
                                                       ,Linux_FirewallInterface GroupComponent
                                                       ,Linux_FirewallManagedPorts PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_FirewallManagedPortsForInterface.PROPERTY_GROUPCOMPONENT_LINUX_FIREWALLINTERFACE.NAME,new CIMDataType(Linux_FirewallInterface.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallManagedPortsForInterface.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_FirewallManagedPortsForInterface.PROPERTY_PARTCOMPONENT_LINUX_FIREWALLMANAGEDPORTS.NAME,new CIMDataType(Linux_FirewallManagedPorts.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallManagedPortsForInterface.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallManagedPortsForInterface.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallManagedPortsForInterface createInstance(WBEMClient client, Linux_FirewallManagedPortsForInterface dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallManagedPortsForInterface newDataInstance = Linux_FirewallManagedPortsForInterfaceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallManagedPortsForInterface modifyInstance(WBEMClient client, Linux_FirewallManagedPortsForInterface dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallManagedPortsForInterface dataInstance2 = Linux_FirewallManagedPortsForInterfaceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallManagedPortsForInterface dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallManagedPortsForInterface.getPackages());
    }
