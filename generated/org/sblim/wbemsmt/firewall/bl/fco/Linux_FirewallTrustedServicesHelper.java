/** 
  * Linux_FirewallTrustedServicesHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallTrustedServices
  *    
  * 
  * generated Class
  * @see Linux_FirewallTrustedServices
  */
...
public class Linux_FirewallTrustedServicesHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallTrustedServices or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallTrustedServices.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallTrustedServices.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallTrustedServices or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallTrustedServices> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallTrustedServices> resultArrayList = new ArrayList<Linux_FirewallTrustedServices>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallTrustedServices.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallTrustedServices(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallTrustedServicesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallTrustedServices.");
                        resultArrayList.add(new Linux_FirewallTrustedServices(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallTrustedServices.");
                        resultArrayList.add(new Linux_FirewallTrustedServices(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallTrustedServices)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallTrustedServices.");
                        resultArrayList.add(new Linux_FirewallTrustedServices(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallTrustedServices getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallTrustedServices getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallTrustedServices dataInstance = null;
        Class<?> clazz = Linux_FirewallTrustedServicesHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallTrustedServices)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallTrustedServices.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallTrustedServices(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallTrustedServices getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_FirewallTrustedServices.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallTrustedServices.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallTrustedServices.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallTrustedServices createInstance(WBEMClient client, Linux_FirewallTrustedServices dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallTrustedServices newDataInstance = Linux_FirewallTrustedServicesHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallTrustedServices modifyInstance(WBEMClient client, Linux_FirewallTrustedServices dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallTrustedServices dataInstance2 = Linux_FirewallTrustedServicesHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallTrustedServices dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallTrustedServices.getPackages());
    }
