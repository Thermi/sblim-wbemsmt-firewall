/** 
  * Linux_FirewallElementConformsToProfileHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallElementConformsToProfile
  *    
  * 
  * generated Class
  * @see Linux_FirewallElementConformsToProfile
  */
...
public class Linux_FirewallElementConformsToProfileHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallElementConformsToProfile or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallElementConformsToProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallElementConformsToProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallElementConformsToProfile or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallElementConformsToProfile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallElementConformsToProfile> resultArrayList = new ArrayList<Linux_FirewallElementConformsToProfile>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallElementConformsToProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallElementConformsToProfile(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallElementConformsToProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallElementConformsToProfile.");
                        resultArrayList.add(new Linux_FirewallElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallElementConformsToProfile.");
                        resultArrayList.add(new Linux_FirewallElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallElementConformsToProfile)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallElementConformsToProfile.");
                        resultArrayList.add(new Linux_FirewallElementConformsToProfile(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallElementConformsToProfile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallElementConformsToProfile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallElementConformsToProfile dataInstance = null;
        Class<?> clazz = Linux_FirewallElementConformsToProfileHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallElementConformsToProfile)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallElementConformsToProfile.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallElementConformsToProfile(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallElementConformsToProfile getInstance(WBEMClient client, String namespace
                                                       ,Linux_FirewallRegisteredProfile ConformantStandard
                                                       ,Linux_FirewallService ManagedElement
        ...
        Object setThis = null;
                                 ...
                                 setThis = ConformantStandard != null ? ConformantStandard.getCimObjectPath() : null;
                           
           keyProperties[0]  = new CIMProperty(Linux_FirewallElementConformsToProfile.PROPERTY_CONFORMANTSTANDARD_LINUX_FIREWALLREGISTEREDPROFILE.NAME,new CIMDataType(Linux_FirewallRegisteredProfile.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallElementConformsToProfile.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_FirewallElementConformsToProfile.PROPERTY_MANAGEDELEMENT_LINUX_FIREWALLSERVICE.NAME,new CIMDataType(Linux_FirewallService.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallElementConformsToProfile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallElementConformsToProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallElementConformsToProfile createInstance(WBEMClient client, Linux_FirewallElementConformsToProfile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallElementConformsToProfile newDataInstance = Linux_FirewallElementConformsToProfileHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallElementConformsToProfile modifyInstance(WBEMClient client, Linux_FirewallElementConformsToProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallElementConformsToProfile dataInstance2 = Linux_FirewallElementConformsToProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallElementConformsToProfile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallElementConformsToProfile.getPackages());
    }
