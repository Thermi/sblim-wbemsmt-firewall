/** 
  * Linux_FirewallServiceConfigurationHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallServiceConfiguration
  *    
  * 
  * generated Class
  * @see Linux_FirewallServiceConfiguration
  */
...
public class Linux_FirewallServiceConfigurationHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallServiceConfiguration or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallServiceConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallServiceConfiguration.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallServiceConfiguration or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallServiceConfiguration> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallServiceConfiguration> resultArrayList = new ArrayList<Linux_FirewallServiceConfiguration>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallServiceConfiguration.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallServiceConfiguration(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallServiceConfigurationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallServiceConfiguration.");
                        resultArrayList.add(new Linux_FirewallServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallServiceConfiguration.");
                        resultArrayList.add(new Linux_FirewallServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallServiceConfiguration)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallServiceConfiguration.");
                        resultArrayList.add(new Linux_FirewallServiceConfiguration(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallServiceConfiguration getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallServiceConfiguration getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallServiceConfiguration dataInstance = null;
        Class<?> clazz = Linux_FirewallServiceConfigurationHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallServiceConfiguration)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallServiceConfiguration.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallServiceConfiguration(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallServiceConfiguration getInstance(WBEMClient client, String namespace
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_FirewallServiceConfiguration.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallServiceConfiguration.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallServiceConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallServiceConfiguration createInstance(WBEMClient client, Linux_FirewallServiceConfiguration dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallServiceConfiguration newDataInstance = Linux_FirewallServiceConfigurationHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallServiceConfiguration modifyInstance(WBEMClient client, Linux_FirewallServiceConfiguration dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallServiceConfiguration dataInstance2 = Linux_FirewallServiceConfigurationHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallServiceConfiguration dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallServiceConfiguration.getPackages());
    }
