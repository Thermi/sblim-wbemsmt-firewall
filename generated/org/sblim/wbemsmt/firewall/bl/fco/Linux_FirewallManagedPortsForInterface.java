/**
 * Linux_FirewallManagedPortsForInterface.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: Any Interface can have more than one
 *            Unreserved Port enabled on it. This association is represented by this mof. generated
 *            Class
 */
...
public class Linux_FirewallManagedPortsForInterface extends CIM_Component {

    public final static String CIM_CLASS_NAME = "Linux_FirewallManagedPortsForInterface";
     ...
     * 
     */
    public static class PROPERTY_PARTCOMPONENT_LINUX_FIREWALLMANAGEDPORTS {
        /**
    ...
    public Linux_FirewallManagedPortsForInterface(WBEMClient client, String namespace)
    ...
    public Linux_FirewallManagedPortsForInterface(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_FirewallManagedPortsForInterface() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("PartComponent", new CIMProperty("PartComponent", new CIMDataType(
                Linux_FirewallManagedPorts.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_GroupComponent_Linux_FirewallInterface(WBEMClient client,
        ...
        Linux_FirewallManagedPortsForInterface fco = new Linux_FirewallManagedPortsForInterface(
                client, namespace);
    ...
    public Linux_FirewallManagedPorts get_PartComponent_Linux_FirewallManagedPorts(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_FIREWALLMANAGEDPORTS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_FIREWALLMANAGEDPORTS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_FirewallManagedPortsHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_PartComponent_Linux_FirewallManagedPorts(Linux_FirewallManagedPorts newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_FIREWALLMANAGEDPORTS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_PartComponent_Linux_FirewallManagedPorts(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public static CIMProperty create_PartComponent_Linux_FirewallManagedPorts(WBEMClient client,
            String namespace, Linux_FirewallManagedPorts newValue) throws WbemsmtException {
        Linux_FirewallManagedPortsForInterface fco = new Linux_FirewallManagedPortsForInterface(
                client, namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_PARTCOMPONENT_LINUX_FIREWALLMANAGEDPORTS.NAME);
        if (property != null) {
            property = setPropertyValue_PartComponent_Linux_FirewallManagedPorts(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_FIREWALLMANAGEDPORTS.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_PartComponent_Linux_FirewallManagedPorts(
            CIMProperty currentProperty, Linux_FirewallManagedPorts newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_FirewallManagedPortsForInterface.CIM_CLASS_NAME;
    }
