/** 
  * Linux_FirewallServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallService
  *    
  * 
  * generated Class
  * @see Linux_FirewallService
  */
...
public class Linux_FirewallServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallService or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallService> resultArrayList = new ArrayList<Linux_FirewallService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallService.");
                        resultArrayList.add(new Linux_FirewallService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallService.");
                        resultArrayList.add(new Linux_FirewallService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallService.");
                        resultArrayList.add(new Linux_FirewallService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallService dataInstance = null;
        Class<?> clazz = Linux_FirewallServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallService getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_FirewallService.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallService.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_FirewallService.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallService.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(Linux_FirewallService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallService.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(Linux_FirewallService.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_FirewallService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallService createInstance(WBEMClient client, Linux_FirewallService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallService newDataInstance = Linux_FirewallServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallService modifyInstance(WBEMClient client, Linux_FirewallService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallService dataInstance2 = Linux_FirewallServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallService.getPackages());
    }
