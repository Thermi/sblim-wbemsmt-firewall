/** 
  * Linux_FirewallRegisteredProfile.java
  *
  * 
  ...
  * 
  * Description: A class which is used during SLP discovery to identifythat the Firewall task is available
  * 
  * generated Class
  */
...
import javax.wbem.*;
public class Linux_FirewallRegisteredProfile extends  CIM_RegisteredProfile {



   public final static String CIM_CLASS_NAME = "Linux_FirewallRegisteredProfile";
...
//**********************************************************************
    ...
    * 
    *       *   <br>
    *   A class which is used during SLP discovery to identifythat the Firewall task is available
    *   @param client the CIM Client
    *   @param namespace the target namespace
    */  

      
   public Linux_FirewallRegisteredProfile(WBEMClient client, String namespace) throws WbemsmtException
   {
   ...
   public Linux_FirewallRegisteredProfile(CIMInstance cimInstance)  throws WbemsmtException { 
    ...
    * Default constructor
    */
   protected Linux_FirewallRegisteredProfile()
   {	
   }
...
//**********************************************************************
    ...
    /**
     * Get the list with Linux_FirewallService objects associated by the association Linux_FirewallElementConformsToProfile
     * 
     ...
     **/
     ...
     public java.util.List<Linux_FirewallService> getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfiles(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfiles(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<Linux_FirewallService> getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfiles(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<Linux_FirewallService> getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfiles(WBEMClient cimClient, String associationClass, String resultClass, String role, String resultRole, boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList) throws WbemsmtException {
         ...
         try {
                 ...
                 Linux_FirewallRegisteredProfileHelper.checkException(enumeration);
                 ...
                 if (obj instanceof CIMInstance) {
                     ...
                     Class<?> clazz = Linux_FirewallRegisteredProfileHelper.findClass(cimClient, cimInstance);
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfileNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfileNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_LINUX_FIREWALLELEMENTCONFORMSTOPROFILE,
    	                             Linux_FirewallService.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfileNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_FirewallService_Linux_FirewallElementConformsToProfileNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
...
//**********************************************************************                         
    ...
    {
    	    return Linux_FirewallRegisteredProfile.CIM_CLASS_NAME;
    }
