/** 
  * Linux_FirewallTrustedServicesForInterfaceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallTrustedServicesForInterface
  *    
  * 
  * generated Class
  * @see Linux_FirewallTrustedServicesForInterface
  */
...
public class Linux_FirewallTrustedServicesForInterfaceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallTrustedServicesForInterface or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallTrustedServicesForInterface.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallTrustedServicesForInterface.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallTrustedServicesForInterface or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallTrustedServicesForInterface> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallTrustedServicesForInterface> resultArrayList = new ArrayList<Linux_FirewallTrustedServicesForInterface>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallTrustedServicesForInterface.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallTrustedServicesForInterface(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallTrustedServicesForInterfaceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallTrustedServicesForInterface.");
                        resultArrayList.add(new Linux_FirewallTrustedServicesForInterface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallTrustedServicesForInterface.");
                        resultArrayList.add(new Linux_FirewallTrustedServicesForInterface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallTrustedServicesForInterface)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallTrustedServicesForInterface.");
                        resultArrayList.add(new Linux_FirewallTrustedServicesForInterface(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallTrustedServicesForInterface getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallTrustedServicesForInterface getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallTrustedServicesForInterface dataInstance = null;
        Class<?> clazz = Linux_FirewallTrustedServicesForInterfaceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallTrustedServicesForInterface)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallTrustedServicesForInterface.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallTrustedServicesForInterface(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallTrustedServicesForInterface getInstance(WBEMClient client, String namespace
                                                       ,Linux_FirewallInterface GroupComponent
                                                       ,Linux_FirewallTrustedServices PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_FirewallTrustedServicesForInterface.PROPERTY_GROUPCOMPONENT_LINUX_FIREWALLINTERFACE.NAME,new CIMDataType(Linux_FirewallInterface.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallTrustedServicesForInterface.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_FirewallTrustedServicesForInterface.PROPERTY_PARTCOMPONENT_LINUX_FIREWALLTRUSTEDSERVICES.NAME,new CIMDataType(Linux_FirewallTrustedServices.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallTrustedServicesForInterface.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallTrustedServicesForInterface.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallTrustedServicesForInterface createInstance(WBEMClient client, Linux_FirewallTrustedServicesForInterface dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallTrustedServicesForInterface newDataInstance = Linux_FirewallTrustedServicesForInterfaceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallTrustedServicesForInterface modifyInstance(WBEMClient client, Linux_FirewallTrustedServicesForInterface dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallTrustedServicesForInterface dataInstance2 = Linux_FirewallTrustedServicesForInterfaceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallTrustedServicesForInterface dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallTrustedServicesForInterface.getPackages());
    }
