/** 
  * Linux_FirewallServiceConfigurationForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_FirewallServiceConfigurationForService
  *    
  * 
  * generated Class
  * @see Linux_FirewallServiceConfigurationForService
  */
...
public class Linux_FirewallServiceConfigurationForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_FirewallServiceConfigurationForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_FirewallServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_FirewallServiceConfigurationForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_FirewallServiceConfigurationForService or the subclasses if deep == true
    */        
    public final static List<Linux_FirewallServiceConfigurationForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_FirewallServiceConfigurationForService> resultArrayList = new ArrayList<Linux_FirewallServiceConfigurationForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_FirewallServiceConfigurationForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_FirewallServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_FirewallServiceConfigurationForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_FirewallServiceConfigurationForService.");
                        resultArrayList.add(new Linux_FirewallServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_FirewallServiceConfigurationForService.");
                        resultArrayList.add(new Linux_FirewallServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_FirewallServiceConfigurationForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallServiceConfigurationForService.");
                        resultArrayList.add(new Linux_FirewallServiceConfigurationForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_FirewallServiceConfigurationForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_FirewallServiceConfigurationForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_FirewallServiceConfigurationForService dataInstance = null;
        Class<?> clazz = Linux_FirewallServiceConfigurationForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_FirewallServiceConfigurationForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_FirewallServiceConfigurationForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_FirewallServiceConfigurationForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_FirewallServiceConfigurationForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_FirewallService Element
                                                       ,Linux_FirewallServiceConfiguration Configuration
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_FirewallServiceConfigurationForService.PROPERTY_ELEMENT_LINUX_FIREWALLSERVICE.NAME,new CIMDataType(Linux_FirewallService.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallServiceConfigurationForService.CIM_CLASS_NAME); 
                   
                                 setThis = Configuration != null ? Configuration.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_FirewallServiceConfigurationForService.PROPERTY_CONFIGURATION_LINUX_FIREWALLSERVICECONFIGURATION.NAME,new CIMDataType(Linux_FirewallServiceConfiguration.CIM_CLASS_NAME),setThis,false,false,Linux_FirewallServiceConfigurationForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_FirewallServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_FirewallServiceConfigurationForService createInstance(WBEMClient client, Linux_FirewallServiceConfigurationForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_FirewallServiceConfigurationForService newDataInstance = Linux_FirewallServiceConfigurationForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_FirewallServiceConfigurationForService modifyInstance(WBEMClient client, Linux_FirewallServiceConfigurationForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_FirewallServiceConfigurationForService dataInstance2 = Linux_FirewallServiceConfigurationForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_FirewallServiceConfigurationForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_FirewallServiceConfigurationForService.getPackages());
    }
