/** 
  * FInterfacesForServicesContainer_AsInterfacesList_InFSupportedServicesWithInterfacesContainerImpl.java
  *
  * 
...
public class FInterfacesForServicesContainer_AsInterfacesList_InFSupportedServicesWithInterfacesContainerImpl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements org.sblim.wbemsmt.firewall.bl.container.edit.FInterfacesForServicesContainer {
	...
	public FInterfacesForServicesContainer_AsInterfacesList_InFSupportedServicesWithInterfacesContainerImpl(org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter,String expressionPrefix,int index) throws WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_IsEnabled() {
    		if (ic_usr_IsEnabled == null)
    		{
				...
				String binding = expressionPrefix + "interfacesList["+ index +"]._usr_IsEnabled.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	{
	    		       FInterfacesForServicesContainer_AsInterfacesList_InFSupportedServicesWithInterfacesContainerImpl source = (FInterfacesForServicesContainer_AsInterfacesList_InFSupportedServicesWithInterfacesContainerImpl)sourceContainer;
