/** 
  * FInterfacesForServicesContainer_AsInterfacesForServiceList_InFInterfacesForServicesListContainerImpl.java
  *
  * 
...
public class FInterfacesForServicesContainer_AsInterfacesForServiceList_InFInterfacesForServicesListContainerImpl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements org.sblim.wbemsmt.firewall.bl.container.edit.FInterfacesForServicesContainer {
	...
	public FInterfacesForServicesContainer_AsInterfacesForServiceList_InFInterfacesForServicesListContainerImpl(org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter,String expressionPrefix,int index) throws WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_DeviceID() {
    		if (ic_DeviceID == null)
    		{
				...
				String binding = expressionPrefix + "interfacesForServiceList["+ index +"]._DeviceID.item";
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_IsEnabled() {
    		if (ic_usr_IsEnabled == null)
    		{
				...
				String binding = expressionPrefix + "interfacesForServiceList["+ index +"]._usr_IsEnabled.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void reload()
	{
		super.reload();
	    		if (ic_DeviceID != null)
    		{
				ic_DeviceID.setLabelText(bundle.getString("FInterfacesForServicesContainer.DeviceID"));
    		}
	    		if (ic_usr_IsEnabled != null)
    		{
				ic_usr_IsEnabled.setLabelText(bundle.getString("FInterfacesForServicesContainer.isEnabled"));
    		}
		}
	...
	{
	    		       FInterfacesForServicesContainer_AsInterfacesForServiceList_InFInterfacesForServicesListContainerImpl source = (FInterfacesForServicesContainer_AsInterfacesForServiceList_InFInterfacesForServicesListContainerImpl)sourceContainer;
