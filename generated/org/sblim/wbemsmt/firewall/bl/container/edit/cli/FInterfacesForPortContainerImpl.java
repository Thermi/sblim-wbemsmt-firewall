/** 
  * FInterfacesForPortContainerImpl.java
  * 
...
public class FInterfacesForPortContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.firewall.bl.container.edit.FInterfacesForPortContainer
	{
	...
	public FInterfacesForPortContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("FInterfacesForPortContainer.caption"));
		}
	...
	{
	    		       FInterfacesForPortContainerImpl source = (FInterfacesForPortContainerImpl)sourceContainer;
