/** 
  * FInterfacesForServicesContainer_AsInterfacesListForPort_InNewManagedPortWizard2ContainerImpl.java
  *
  * 
...
public class FInterfacesForServicesContainer_AsInterfacesListForPort_InNewManagedPortWizard2ContainerImpl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements org.sblim.wbemsmt.firewall.bl.container.edit.FInterfacesForServicesContainer {
	...
	public FInterfacesForServicesContainer_AsInterfacesListForPort_InNewManagedPortWizard2ContainerImpl(org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter,String expressionPrefix,int index) throws WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_DeviceID() {
    		if (ic_DeviceID == null)
    		{
				...
				String binding = expressionPrefix + "interfacesListForPort["+ index +"]._DeviceID.item";
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_IsEnabled() {
    		if (ic_usr_IsEnabled == null)
    		{
				...
				String binding = expressionPrefix + "interfacesListForPort["+ index +"]._usr_IsEnabled.item";
				logger.fine("Using binding " + binding);
				DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	{
	    		       FInterfacesForServicesContainer_AsInterfacesListForPort_InNewManagedPortWizard2ContainerImpl source = (FInterfacesForServicesContainer_AsInterfacesListForPort_InNewManagedPortWizard2ContainerImpl)sourceContainer;
