...
public class FInterfaceContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.firewall.bl.container.edit.FInterfaceContainer
	{
	...
	public FInterfaceContainerImpl(org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "FInterfaceContainer.caption",false);
        	        		...
        	        		addComponent((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent)get_IsTrusted());
        					
		setFooter(getPanelForCustomLayout(),"FInterfaceContainer.footerText");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_IsTrusted() {
    		if (ic_IsTrusted == null)
    		{
				...
				String binding = expressionPrefix + "_IsTrusted.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
