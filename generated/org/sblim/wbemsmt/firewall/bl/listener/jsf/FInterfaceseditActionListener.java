...
public class FInterfaceseditActionListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("FIREWALL", "FInterfaceseditActionListener");
        ...
        bean = new org.sblim.wbemsmt.firewall.bl.listener.jsf.FInterfaceseditActionListenerEditBeanFieldTab();
        editBeans.add(bean);
        bean.edit(treeNode);
