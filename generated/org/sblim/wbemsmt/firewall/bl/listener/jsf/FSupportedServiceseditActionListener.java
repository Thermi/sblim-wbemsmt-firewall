...
public class FSupportedServiceseditActionListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("FIREWALL", "FSupportedServiceseditActionListener");
        ...
        bean = new org.sblim.wbemsmt.firewall.bl.listener.jsf.FSupportedServiceseditActionListenerEditBeanFieldTab();
        editBeans.add(bean);
        bean.edit(treeNode);
