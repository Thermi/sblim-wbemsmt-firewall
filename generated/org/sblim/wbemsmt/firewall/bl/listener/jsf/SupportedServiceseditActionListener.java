...
public class SupportedServiceseditActionListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("FIREWALL", "SupportedServiceseditActionListener");
        ...
        bean = new org.sblim.wbemsmt.firewall.bl.listener.jsf.SupportedServiceseditActionListenerEditBeanFieldTab();
        editBeans.add(bean);
        bean.edit(treeNode);
