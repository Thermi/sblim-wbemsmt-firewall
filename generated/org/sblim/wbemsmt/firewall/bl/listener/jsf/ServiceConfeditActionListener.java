...
public class ServiceConfeditActionListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("FIREWALL", "ServiceConfeditActionListener");
        ...
        //ADD THE CONTAINERS IN TAB ServiceTab			
        bean = new org.sblim.wbemsmt.firewall.bl.listener.jsf.ServiceConfeditActionListenerEditBeanServiceTab();
        editBeans.add(bean);
        bean.edit(treeNode);
        oac.addEditBean("ServiceTab", bean);
        bundleKey = "tab.ServiceTab";
        tabbedPane.addTab("ServiceTab", bundleKey, bean.getPanel());

        //ADD THE CONTAINERS IN TAB ServiceOptionsTab			
        bean = new org.sblim.wbemsmt.firewall.bl.listener.jsf.ServiceConfeditActionListenerEditBeanServiceOptionsTab();
        editBeans.add(bean);
        bean.edit(treeNode);
        oac.addEditBean("ServiceOptionsTab", bean);
        bundleKey = "tab.ServiceOptionsTab";
        tabbedPane.addTab("ServiceOptionsTab", bundleKey, bean.getPanel());
