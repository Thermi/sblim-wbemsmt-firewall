/**
 * FSupportedServiceseditActionListenerEditBeanFieldTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS
...
public class FSupportedServiceseditActionListenerEditBeanFieldTab extends EditBean {

    private org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FSupportedServicesWithInterfacesContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public FSupportedServiceseditActionListenerEditBeanFieldTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container FSupportedServicesWithInterfacesContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "FSupportedServiceseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER FSupportedServicesWithInterfacesContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['fieldTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FSupportedServicesWithInterfacesContainerImpl(
        ...
        {
            EditBasePanel basePanel = (org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FSupportedServicesContainerImpl) ((org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FSupportedServicesWithInterfacesContainerImpl) currentEditContainer1)
                    .getServiceList();
            HtmlPanelGrid childPanel = (HtmlPanelGrid) basePanel.getInputFieldContainer();
            childPanel.setStyleClass("singleLineChildTable");
            childPanel.setId(org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent
                    .asJsfId("FSupportedServiceseditPanel.Child_serviceList"));
        ...
        //add the childs with occurence list
        {
            HtmlPanelGrid childPanel = currentEditContainer1.getInterfacesListPanel()
                    .getOuterPanel();
            childPanel.setId(org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent
                    .asJsfId("FSupportedServiceseditPanelChild_interfacesList"));
            childEditFields.getChildren().add(childPanel);
        }
