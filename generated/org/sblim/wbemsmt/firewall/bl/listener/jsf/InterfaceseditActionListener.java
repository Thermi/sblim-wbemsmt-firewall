...
public class InterfaceseditActionListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("FIREWALL", "InterfaceseditActionListener");
        ...
        bean = new org.sblim.wbemsmt.firewall.bl.listener.jsf.InterfaceseditActionListenerEditBeanFieldTab();
        editBeans.add(bean);
        bean.edit(treeNode);
