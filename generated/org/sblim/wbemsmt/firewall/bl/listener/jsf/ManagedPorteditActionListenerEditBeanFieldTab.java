/**
 * ManagedPorteditActionListenerEditBeanFieldTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class ManagedPorteditActionListenerEditBeanFieldTab extends EditBean {

    private org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallManagedPortContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public ManagedPorteditActionListenerEditBeanFieldTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container FirewallManagedPortContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "ManagedPorteditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER FirewallManagedPortContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['fieldTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallManagedPortContainerImpl(
        ...
        {
            HtmlPanelGrid childPanel = currentEditContainer1.getInterfacesForPortPanel()
                    .getOuterPanel();
            childPanel.setId(org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent
                    .asJsfId("ManagedPorteditPanelChild_interfacesForPort"));
