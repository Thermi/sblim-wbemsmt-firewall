/**
 * SupportedServiceseditActionListenerEditBeanFieldTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS
...
public class SupportedServiceseditActionListenerEditBeanFieldTab extends EditBean {

    private org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallSupportedServicesContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public SupportedServiceseditActionListenerEditBeanFieldTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container FirewallSupportedServicesContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "SupportedServiceseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER FirewallSupportedServicesContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['fieldTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallSupportedServicesContainerImpl(
