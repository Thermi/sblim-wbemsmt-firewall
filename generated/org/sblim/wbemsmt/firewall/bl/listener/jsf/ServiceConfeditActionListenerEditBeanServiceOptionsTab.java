/**
 * ServiceConfeditActionListenerEditBeanServiceOptionsTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS
...
public class ServiceConfeditActionListenerEditBeanServiceOptionsTab extends EditBean {

    private org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallServiceOptionsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public ServiceConfeditActionListenerEditBeanServiceOptionsTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container FirewallServiceOptionsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "ServiceOptionseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER FirewallServiceOptionsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['ServiceOptionsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallServiceOptionsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['ServiceOptionsTab'].");
