/**
 * ServiceConfeditActionListenerEditBeanServiceTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE
...
public class ServiceConfeditActionListenerEditBeanServiceTab extends EditBean {

    private org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallServiceConfContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public ServiceConfeditActionListenerEditBeanServiceTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container FirewallServiceConfContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "ServiceConfeditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER FirewallServiceConfContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['ServiceTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallServiceConfContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['ServiceTab'].");
