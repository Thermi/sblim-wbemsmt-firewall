/**
 * InterfaceseditActionListenerEditBeanFieldTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class InterfaceseditActionListenerEditBeanFieldTab extends EditBean {

    private org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallInterfacesContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.firewall.bl.adapter.FirewallCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public InterfaceseditActionListenerEditBeanFieldTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container FirewallInterfacesContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        //ADD THE FIELDS FOR CONTAINER FirewallInterfacesContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['fieldTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.firewall.bl.container.edit.jsf.FirewallInterfacesContainerImpl(
