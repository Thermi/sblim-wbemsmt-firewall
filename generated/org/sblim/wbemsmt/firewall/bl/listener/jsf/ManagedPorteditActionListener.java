...
public class ManagedPorteditActionListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("FIREWALL", "ManagedPorteditActionListener");
        ...
        bean = new org.sblim.wbemsmt.firewall.bl.listener.jsf.ManagedPorteditActionListenerEditBeanFieldTab();
        editBeans.add(bean);
        bean.edit(treeNode);
