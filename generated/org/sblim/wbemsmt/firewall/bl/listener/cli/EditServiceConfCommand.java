/**
 * EditServiceConfCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditServiceConfCommand extends CimCommand {

    //All Options that are local and defined for this command
    /**
     *  --configurationFile
     */
    public static final OptionDefinition KEY_configurationFile = new OptionDefinition(null,
            "configurationFile", null, "FirewallServiceConfContainer.configurationFile.argValue",
            false, false, "FirewallServiceConfContainer.configurationFile.argDescription");
    /**
     *  --startService
     */
    public static final OptionDefinition KEY_startService = new OptionDefinition(null,
            "startService", null, null, false, false,
            "FirewallServiceConfContainer.StartService.argDescription");
    /**
     *  --stopService
     */
    public static final OptionDefinition KEY_stopService = new OptionDefinition(null,
            "stopService", null, null, false, false,
            "FirewallServiceConfContainer.StopService.argDescription");
    /**
     *  --restartService
     */
    public static final OptionDefinition KEY_restartService = new OptionDefinition(null,
            "restartService", null, null, false, false,
            "FirewallServiceConfContainer.restartService.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_configurationFile, KEY_startService, KEY_stopService, KEY_restartService, };
    ...
    public EditServiceConfCommand(java.util.Locale locale) {
        super("EditServiceConfCommand", new String[] { "messages", "messagesFirewall" }, locale);
    }
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("FirewallServiceConfContainer.caption") }));

            CliDataLoader loader = new EditServiceConfCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallServiceConfContainerImpl dc = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallServiceConfContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallServiceConfContainer dc)
    ...
    private void setValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
        ...
        //The Buttons
        if (!pressButton(cmd, adapter, dc, dc.get_invoke_StartService(), KEY_startService))
            return;
        if (!pressButton(cmd, adapter, dc, dc.get_invoke_StopService(), KEY_stopService))
            return;
        if (!pressButton(cmd, adapter, dc, dc.get_usr_RestartService(), KEY_restartService))
            return;
    }
