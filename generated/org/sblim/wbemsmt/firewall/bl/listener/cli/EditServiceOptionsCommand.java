/**
 * EditServiceOptionsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditServiceOptionsCommand extends CimCommand {

    //All Options that are local and defined for this command
    /**
     *  --iPTABLES_MODULES
     */
    public static final OptionDefinition KEY_iPTABLES_MODULES = new OptionDefinition(null,
            "iPTABLES_MODULES", null, "FirewallServiceOptionsContainer.IPTABLES_MODULES.argValue",
            false, false, "FirewallServiceOptionsContainer.IPTABLES_MODULES.argDescription");
    /**
     *  --iPTABLES_MODULES_UNLOAD
     */
    public static final OptionDefinition KEY_iPTABLES_MODULES_UNLOAD = new OptionDefinition(null,
            "iPTABLES_MODULES_UNLOAD", null,
            "FirewallServiceOptionsContainer.IPTABLES_MODULES_UNLOAD.argValue", false, false,
            "FirewallServiceOptionsContainer.IPTABLES_MODULES_UNLOAD.argDescription");
    /**
     *  --iPTABLES_SAVE_COUNTER
     */
    public static final OptionDefinition KEY_iPTABLES_SAVE_COUNTER = new OptionDefinition(null,
            "iPTABLES_SAVE_COUNTER", null,
            "FirewallServiceOptionsContainer.IPTABLES_SAVE_COUNTER.argValue", false, false,
            "FirewallServiceOptionsContainer.IPTABLES_SAVE_COUNTER.argDescription");
    /**
     *  --iPTABLES_SAVE_ON_RESTART
     */
    public static final OptionDefinition KEY_iPTABLES_SAVE_ON_RESTART = new OptionDefinition(null,
            "iPTABLES_SAVE_ON_RESTART", null,
            "FirewallServiceOptionsContainer.IPTABLES_SAVE_ON_RESTART.argValue", false, false,
            "FirewallServiceOptionsContainer.IPTABLES_SAVE_ON_RESTART.argDescription");
    /**
     *  --iPTABLES_SAVE_ON_STOP
     */
    public static final OptionDefinition KEY_iPTABLES_SAVE_ON_STOP = new OptionDefinition(null,
            "iPTABLES_SAVE_ON_STOP", null,
            "FirewallServiceOptionsContainer.IPTABLES_SAVE_ON_STOP.argValue", false, false,
            "FirewallServiceOptionsContainer.IPTABLES_SAVE_ON_STOP.argDescription");
    /**
     *  --iPTABLES_STATUS_LINENUMBERS
     */
    public static final OptionDefinition KEY_iPTABLES_STATUS_LINENUMBERS = new OptionDefinition(
            null, "iPTABLES_STATUS_LINENUMBERS", null,
            "FirewallServiceOptionsContainer.IPTABLES_STATUS_LINENUMBERS.argValue", false, false,
            "FirewallServiceOptionsContainer.IPTABLES_STATUS_LINENUMBERS.argDescription");
    /**
     *  --iPTABLES_STATUS_NUMERIC
     */
    public static final OptionDefinition KEY_iPTABLES_STATUS_NUMERIC = new OptionDefinition(null,
            "iPTABLES_STATUS_NUMERIC", null,
            "FirewallServiceOptionsContainer.IPTABLES_STATUS_NUMERIC.argValue", false, false,
            "FirewallServiceOptionsContainer.IPTABLES_STATUS_NUMERIC.argDescription");
    /**
     *  --iPTABLES_STATUS_VERBOSE
     */
    public static final OptionDefinition KEY_iPTABLES_STATUS_VERBOSE = new OptionDefinition(null,
            "iPTABLES_STATUS_VERBOSE", null,
            "FirewallServiceOptionsContainer.IPTABLES_STATUS_VERBOSE.argValue", false, false,
            "FirewallServiceOptionsContainer.IPTABLES_STATUS_VERBOSE.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_iPTABLES_MODULES, KEY_iPTABLES_MODULES_UNLOAD, KEY_iPTABLES_SAVE_COUNTER,
            KEY_iPTABLES_SAVE_ON_RESTART, KEY_iPTABLES_SAVE_ON_STOP,
            KEY_iPTABLES_STATUS_LINENUMBERS, KEY_iPTABLES_STATUS_NUMERIC,
            KEY_iPTABLES_STATUS_VERBOSE, };
    ...
    public EditServiceOptionsCommand(java.util.Locale locale) {
        super("EditServiceOptionsCommand", new String[] { "messages", "messagesFirewall" }, locale);
    }
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("FirewallServiceOptionsContainer.caption") }));

            CliDataLoader loader = new EditServiceOptionsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallServiceOptionsContainerImpl dc = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallServiceOptionsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallServiceOptionsContainer dc)
    ...
    private void setValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallServiceOptionsContainer dc)
            throws WbemsmtException {
        setValue(cmd, dc.get_IPTABLES_MODULES(), KEY_iPTABLES_MODULES);
        setCheckboxValue(cmd, dc.get_IPTABLES_MODULES_UNLOAD(), KEY_iPTABLES_MODULES_UNLOAD);
        setCheckboxValue(cmd, dc.get_IPTABLES_SAVE_COUNTER(), KEY_iPTABLES_SAVE_COUNTER);
        setCheckboxValue(cmd, dc.get_IPTABLES_SAVE_ON_RESTART(), KEY_iPTABLES_SAVE_ON_RESTART);
        setCheckboxValue(cmd, dc.get_IPTABLES_SAVE_ON_STOP(), KEY_iPTABLES_SAVE_ON_STOP);
        setCheckboxValue(cmd, dc.get_IPTABLES_STATUS_LINENUMBERS(), KEY_iPTABLES_STATUS_LINENUMBERS);
        setCheckboxValue(cmd, dc.get_IPTABLES_STATUS_NUMERIC(), KEY_iPTABLES_STATUS_NUMERIC);
        setCheckboxValue(cmd, dc.get_IPTABLES_STATUS_VERBOSE(), KEY_iPTABLES_STATUS_VERBOSE);
