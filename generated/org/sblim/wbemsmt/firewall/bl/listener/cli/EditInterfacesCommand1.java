/**
 * EditInterfacesCommand1.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditInterfacesCommand1 extends CimCommand {
    ...
    public static final OptionDefinition KEY_isTrusted = new OptionDefinition(null, "isTrusted",
            null, "FirewallInterfacesContainer.isTrusted.argValue", false, false,
            "FirewallInterfacesContainer.isTrusted.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_isTrusted, };
    ...
    public EditInterfacesCommand1(java.util.Locale locale) {
        super("EditInterfacesCommand1", new String[] { "messages", "messagesFirewall" }, locale);
    }
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("FirewallInterfacesContainer.caption") }));

            CliDataLoader loader = new EditInterfacesCommand1Loader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallInterfacesContainerImpl dc = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallInterfacesContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallInterfacesContainer dc)
    ...
    private void setValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallInterfacesContainer dc)
            throws WbemsmtException {
        setCheckboxValue(cmd, dc.get_usr_IsTrusted(), KEY_isTrusted);
