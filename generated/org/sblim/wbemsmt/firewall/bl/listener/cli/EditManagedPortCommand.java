/**
 * EditManagedPortCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditManagedPortCommand extends CimCommand {

    //All Options that are local and defined for this command
    /**
     * used for selection:  --instanceID
     */
    public static final OptionDefinition KEY_instanceID = new OptionDefinition(null, "instanceID",
            null, "EditManagedPortCommand.instanceID.argValue", false, false,
            "EditManagedPortCommand.instanceID.argDescription");
    /**
     *  --deviceID
     */
    public static final OptionDefinition KEY_deviceID = new OptionDefinition(null, "deviceID",
            null, "EditManagedPortCommand.deviceID.argValue", false, false,
            "EditManagedPortCommand.deviceID.argDescription");
    /**
     *  --isEnabled
     */
    public static final OptionDefinition KEY_isEnabled = new OptionDefinition(null, "isEnabled",
            null, "EditManagedPortCommand.isEnabled.argValue", false, false,
            "EditManagedPortCommand.isEnabled.argDescription");
    /**
     *  --startPort
     */
    public static final OptionDefinition KEY_startPort = new OptionDefinition(null, "startPort",
            null, "FirewallManagedPortContainer.StartPort.argValue", false, false,
            "FirewallManagedPortContainer.StartPort.argDescription");
    /**
     *  --endPort
     */
    public static final OptionDefinition KEY_endPort = new OptionDefinition(null, "endPort", null,
            "FirewallManagedPortContainer.EndPort.argValue", false, false,
            "FirewallManagedPortContainer.EndPort.argDescription");
    /**
     *  --protocol
     */
    public static final OptionDefinition KEY_protocol = new OptionDefinition(null, "protocol",
            null, "FirewallManagedPortContainer.Protocol.argValue", false, false,
            "FirewallManagedPortContainer.Protocol.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_instanceID, KEY_deviceID, KEY_isEnabled, KEY_startPort, KEY_endPort, KEY_protocol, };
    ...
    public EditManagedPortCommand(java.util.Locale locale) {
        super("EditManagedPortCommand", new String[] { "messages", "messagesFirewall" }, locale);
    }
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            CliDataLoader loader = new EditManagedPortCommandLoader();
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallManagedPortContainer dc)
    ...
    private void setValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallManagedPortContainer dc)
            throws WbemsmtException {
        setValue(cmd, dc.get_StartPort(), KEY_startPort);
        setValue(cmd, dc.get_EndPort(), KEY_endPort);
        setMultiValue(adapter.getBundle(), cmd, dc.get_Protocol(), KEY_protocol);
