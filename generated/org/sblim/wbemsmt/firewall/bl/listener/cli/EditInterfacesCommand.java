/**
 * EditInterfacesCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditInterfacesCommand extends CimCommand {

    //All Options that are local and defined for this command
    /**
     * required, used for selection:  --deviceID
     */
    public static final OptionDefinition KEY_deviceID = new OptionDefinition(null, "deviceID",
            null, "EditInterfacesCommand.deviceID.argValue", true, false,
            "EditInterfacesCommand.deviceID.argDescription");
    /**
     *  --isTrusted
     */
    public static final OptionDefinition KEY_isTrusted = new OptionDefinition(null, "isTrusted",
            null, "EditInterfacesCommand.isTrusted.argValue", false, false,
            "EditInterfacesCommand.isTrusted.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_deviceID,
            KEY_isTrusted, };
    ...
    public EditInterfacesCommand(java.util.Locale locale) {
        super("EditInterfacesCommand", new String[] { "messages", "messagesFirewall" }, locale);
    }
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("FInterfacesListContainer.caption") }));

            CliDataLoader loader = new EditInterfacesCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.firewall.bl.container.edit.cli.FInterfacesListContainerImpl dc = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FInterfacesListContainerImpl(
                    adapter);
            int count = 0;

            count = adapter.count("interfacesList",
                    org.sblim.wbemsmt.firewall.bl.container.edit.FInterfaceContainer.class, dc);
            dc.getInterfacesList().clear();
            for (int i = 0; i < count; i++) {
                org.sblim.wbemsmt.firewall.bl.container.edit.cli.FInterfaceContainerImpl child = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FInterfaceContainerImpl(
                        adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FInterfacesListContainer dc)
