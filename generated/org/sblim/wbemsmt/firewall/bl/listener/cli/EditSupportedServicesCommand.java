/**
 * EditSupportedServicesCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditSupportedServicesCommand extends CimCommand {

    //All Options that are local and defined for this command
    /**
     * used for selection:  --serviceName
     */
    public static final OptionDefinition KEY_serviceName = new OptionDefinition(null,
            "serviceName", null, "EditSupportedServicesCommand.serviceName.argValue", false, false,
            "EditSupportedServicesCommand.serviceName.argDescription");
    /**
     *  --deviceID
     */
    public static final OptionDefinition KEY_deviceID = new OptionDefinition(null, "deviceID",
            null, "EditSupportedServicesCommand.deviceID.argValue", false, false,
            "EditSupportedServicesCommand.deviceID.argDescription");
    /**
     *  --isEnabled
     */
    public static final OptionDefinition KEY_isEnabled = new OptionDefinition(null, "isEnabled",
            null, "EditSupportedServicesCommand.isEnabled.argValue", false, false,
            "EditSupportedServicesCommand.isEnabled.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_serviceName, KEY_deviceID, KEY_isEnabled, };
    ...
    public EditSupportedServicesCommand(java.util.Locale locale) {
        super("EditSupportedServicesCommand", new String[] { "messages", "messagesFirewall" },
                locale);
    }
        ...
        try {
                            ...
                            "\n"
                                    + bundle
                                            .getString(
                                                    "editing",
                                                    new Object[] { bundle
                                                            .getString("FSupportedServicesWithInterfacesContainer.caption") }));

            CliDataLoader loader = new EditSupportedServicesCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.firewall.bl.container.edit.cli.FSupportedServicesWithInterfacesContainerImpl dc = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FSupportedServicesWithInterfacesContainerImpl(
                    adapter);
            int count = 0;
            ...
            for (int i = 0; i < count; i++) {
                org.sblim.wbemsmt.firewall.bl.container.edit.cli.FInterfacesForServicesContainerImpl child = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FInterfacesForServicesContainerImpl(
                        adapter);
                dc.getInterfacesList().add(child);
            }
    ...
    private void setKeyValues(
            ...
            org.sblim.wbemsmt.firewall.bl.container.edit.FSupportedServicesWithInterfacesContainer dc)
