/**
 * EditSupportedServicesCommand1.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditSupportedServicesCommand1 extends CimCommand {

    //All Options that are local and defined for this command
    /**
     *  --enableOnInterface
     */
    public static final OptionDefinition KEY_enableOnInterface = new OptionDefinition(null,
            "enableOnInterface", null,
            "FirewallSupportedServicesContainer.enableOnInterface.argValue", false, false,
            "FirewallSupportedServicesContainer.enableOnInterface.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_enableOnInterface, };
    ...
    public EditSupportedServicesCommand1(java.util.Locale locale) {
        super("EditSupportedServicesCommand1", new String[] { "messages", "messagesFirewall" },
                locale);
    }
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("FirewallSupportedServicesContainer.caption") }));

            CliDataLoader loader = new EditSupportedServicesCommand1Loader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallSupportedServicesContainerImpl dc = new org.sblim.wbemsmt.firewall.bl.container.edit.cli.FirewallSupportedServicesContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallSupportedServicesContainer dc)
    ...
    private void setValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.firewall.bl.container.edit.FirewallSupportedServicesContainer dc)
            throws WbemsmtException {
        setCheckboxValue(cmd, dc.get_usr_EnableOnInterface(), KEY_enableOnInterface);
