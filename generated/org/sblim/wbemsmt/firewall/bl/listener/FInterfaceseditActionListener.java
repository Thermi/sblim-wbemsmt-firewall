/**
 * FInterfaceseditActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class FInterfaceseditActionListener extends TaskLauncherContextMenuEventListenerImpl
        implements org.sblim.wbemsmt.tasklauncher.event.EditListener {

    String jsfListener = "org.sblim.wbemsmt.firewall.bl.listener.jsf.FInterfaceseditActionListener";
    String swingListener = "org.sblim.wbemsmt.firewall.bl.listener.jswing.FInterfaceseditActionListener";

    //String cmdListener = "org.sblim.wbemsmt.firewall.bl.listener.cli.FInterfaceseditActionListener";
