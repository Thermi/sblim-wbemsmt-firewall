/** 
 * DeleteManagedPortCommandLoader.java
 *
* 
...
public class DeleteManagedPortCommandLoader extends FirewallLoader implements CliDataLoader {
	...
	public void load ( WbemSmtResourceBundle bundle, AbstractBaseCimAdapter adapter, CimCommandValues commandValues )
		...
		selectPort ( bundle, adapter, "rhino1" ,CliUtil.getOption ( cmd, DeleteManagedPortCommand.KEY_instanceID ));
